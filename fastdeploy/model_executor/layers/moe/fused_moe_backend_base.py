...
class MoEMethodBase(QuantMethodBase):
    ...
    def init_ep(self, layer: nn.Layer) -> None:
        ...
        if config.parallel_config.ep_prefill_use_worst_num_tokens:
            ...
            prefill_num_worst_tokens = config.scheduler_config.max_num_batched_tokens // config.parallel_config.tensor_parallel_size * layer.ep_size * layer.top_k // token_split_factor
        else:
